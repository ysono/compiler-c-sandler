...
impl InstrsGenerator {
    ...
    fn gen_instructions(
        ...
        t_instrs.into_iter().flat_map(|t_instr| match t_instr {
            ...
            t::Instruction::DoubleToInt(t_srcdst) => self.gen_double_to_int(t_srcdst),
            t::Instruction::DoubleToUInt(t_srcdst) => self.gen_double_to_uint(t_srcdst),
            t::Instruction::IntToDouble(t_srcdst) => self.gen_int_to_double(t_srcdst),
            t::Instruction::UIntToDouble(t_srcdst) => self.gen_uint_to_double(t_srcdst),
